...
def use_filter(x, randomNubersGenerator, key, counter):
    ...
    return key, convList2Array([Yx0, Yy0, Yz0])
...
def get_args():
    ...
    parser.add_argument("--data_out", type=str, default=os.path.join(main_data_path, "keypoints-01-raw_wb_3d_korean_part01.h5"))
